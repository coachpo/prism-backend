...
├── test_config_import_export_cases/
...
- Profile-targeted config import/export: `test_config_import_export.py`, `test_config_import_export_cases/`
- Priority/order isolation: `test_connection_priority_isolation.py`
- Top-level suite export: `../test_multi_profile_isolation.py`

## CONVENTIONS

- Keep tests framed in FR/profile-isolation semantics; many files map directly to requirement IDs rather than CRUD surfaces.
