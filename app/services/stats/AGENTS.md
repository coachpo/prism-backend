...
## OVERVIEW
`services/stats/` is the telemetry and query cluster behind `../stats_service.py`: request-log writes, filtered request-log listing with request-id focus, summary rollups, spending reports, and preset time-window resolution.
