...
## OVERVIEW
`bootstrap/` owns startup sequencing and the shared auth middleware mounted by `app/main.py`.
...
- Main lifecycle wiring: `../main.py`

## CONVENTIONS

- Keep startup ordering centralized in `run_startup_sequence()`; `main.py` should only call it from lifespan.
